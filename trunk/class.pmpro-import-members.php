...
/**
 * Copyright 2017-2019 - Thomas Sjolshagen (https://eighty20results.com/thomas-sjolshagen)
 *
...
class Import_Members_From_CSV {
	...
	public static function is_pmpro_active() {
		...
		return in_array( 'paid-memberships-pro/paid-memberships-pro.php', $active_plugins );
	}
	...
	public function load_hooks() {
		...
		add_action( 'e20r-after-user-import', array(
			Import_Member::get_instance(),
			'import_membership_info',
		), - 1, 2 );
		add_action( 'e20r-after-user-import', array( Data::get_instance(), 'cleanup' ), 9999, 2 );
	...
	public function remove_IUCSV_support() {
		...
		if ( has_action( 'is_iu_pre_user_import', 'pmproiufcsv_is_iu_pre_user_import' ) ) {
			...
			remove_action( 'is_iu_pre_user_import', 'pmproiufcsv_is_iu_pre_user_import', 10, 2 );
			remove_action( 'is_iu_post_user_import', 'pmproiufcsv_is_iu_post_user_import' );
			remove_filter( 'is_iu_import_usermeta', 'pmproiufcsv_is_iu_import_usermeta', 10, 2 );
		}
	...
	public function plugin_row_meta( $links, $file ) {
		...
		if ( false !== strpos( $file, 'class.pmpro-import-members.php' ) ) {
