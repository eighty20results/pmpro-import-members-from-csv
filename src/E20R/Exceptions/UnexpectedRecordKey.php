 ...
 *
 * @package E20R\Exceptions\UnexpectedRecordKey
 */
...
if ( ! class_exists( 'E20R\Exception\UnexpectedRecordKey' ) ) {
	/**
	 * Custom exception raised when the record (array generated from the CSV file) lacks an expected key
	 */
	class UnexpectedRecordKey extends Exception {
