 ...
 *
 * @package E20R\Exceptions\InvalidInstantiation
 */
...
if ( ! class_exists( 'E20R\Exception\InvalidInstantiation' ) ) {
	/**
	 * Custom exception raised when a class was instantiated in an unexpected way.
	 */
	class InvalidInstantiation extends Exception {
