 ...
 *
 * @package E20R\Exceptions\UserIDAlreadyExists
 */
...
if ( ! class_exists( 'E20R\Exception\UserIDAlreadyExists' ) ) {
	/**
	 * Custom exception raised if the import User ID already exists and the option to update_id is false
	 */
	class UserIDAlreadyExists extends Exception {
