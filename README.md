...
`Just to be clear: The __only__ date format for the `membership_startdate`, `membership_enddate` and the `user_registered` columns that this plugin will accept is the MySQL datetime format: YYYY` <br />-MM-DD HH:ii:ss.
