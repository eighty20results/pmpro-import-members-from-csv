...
[![Release to wordpress.org](https://github.com/eighty20results/pmpro-import-members-from-csv/actions/workflows/release-plugin.yml/badge.svg)](https://github.com/eighty20results/pmpro-import-members-from-csv/actions/workflows/release-plugin.yml)[![codecov](https://codecov.io/gh/eighty20results/pmpro-import-members-from-csv/branch/main/graph/badge.svg?token=HCWOGJJ5RL)](https://codecov.io/gh/eighty20results/pmpro-import-members-from-csv)
...
Just to be clear: The __only__ date format for the `membership_startdate`, `membership_enddate` and the
...
First, you will need to include a `pmprosm_seats` column as well. This column contains a numeric value to
